package com.ixiangliu.modules.job.utils;
...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            //构建job信息
            JobDetail jobDetail = JobBuilder.newJob(MyScheduleJob.class).withIdentity(getJobKey(scheduleJob.getJobId())).build();
            //表达式调度构建器
            ...
            //暂停任务
            if (scheduleJob.getStatus() == Const.ScheduleStatus.PAUSE.getValue()) {
